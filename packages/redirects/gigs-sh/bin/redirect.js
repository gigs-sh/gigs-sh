#!/usr/bin/env node
// gigs-sh — defensive name reservation, forwards to the canonical `agentgigs` CLI.
// Source: https://github.com/gigs-sh/gigs-sh/tree/main/packages/redirects/gigs-sh
